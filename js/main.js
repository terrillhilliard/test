...
const I18N = {
  ...
  'promo.badge':    { en: 'First visit · Today only', vi: 'Lần đầu · Chỉ hôm nay' },
  'promo.title':    { en: 'Your first visit is <em>20% off.</em>', vi: 'Lần đầu của bạn <em>giảm 20%.</em>' },
  'promo.sub':      { en: "New to Nón Boutique Spa? Claim your welcome discount before today's offer runs out.",
                      vi: 'Lần đầu đến Nón Boutique Spa? Nhận ưu đãi chào mừng trước khi ưu đãi hôm nay kết thúc.' },
  'promo.b1':       { en: '<b>20% off</b> any treatment — up to 80.000₫ saved', vi: '<b>Giảm 20%</b> mọi liệu trình — tiết kiệm tới 80.000₫' },
  'promo.b2':       { en: '<b>Foot, body, hot stone &amp; oil</b> — your choice', vi: '<b>Chân, toàn thân, đá nóng &amp; tinh dầu</b> — tùy chọn' },
  'promo.b3':       { en: '<b>Walk-in or reserve</b> — just mention this offer', vi: '<b>Đến trực tiếp hoặc đặt trước</b> — chỉ cần nhắc ưu đãi này' },
  'promo.ends':     { en: 'Offer ends in', vi: 'Ưu đãi kết thúc sau' },
  'promo.nameph':   { en: 'Your name (optional)', vi: 'Tên của bạn (không bắt buộc)' },
  'promo.cta':      { en: 'Claim my 20% off', vi: 'Nhận ưu đãi 20%' },
  'promo.fine':     { en: 'First-time guests only · Show at reception or mention on WhatsApp',
                      vi: 'Chỉ dành cho khách lần đầu · Xuất trình tại quầy hoặc nhắc khi nhắn WhatsApp' },
  ...
  'chat.q1':        { en: 'Xin chào! 🌿 Which treatment(s) would you like? Tap any that apply:', vi: 'Xin chào! 🌿 Bạn muốn liệu trình nào? Chạm chọn các mục phù hợp:' },
  'chat.next':      { en: 'Next →', vi: 'Tiếp →' },
  'chat.fname':     { en: 'Great choice! What is your first name?', vi: 'Tuyệt vời! Tên của bạn là gì?' },
  'chat.lname':     { en: 'And your last name?', vi: 'Còn họ của bạn?' },
  'chat.phone':     { en: 'Best phone number to reach you?', vi: 'Số điện thoại tốt nhất để liên hệ?' },
  'chat.times':     { en: 'Which days & times work best for you?', vi: 'Ngày và giờ nào thuận tiện nhất cho bạn?' },
  'chat.type':      { en: 'Type your answer…', vi: 'Nhập câu trả lời…' },
  'chat.summary':   { en: "Perfect — here's your request:", vi: 'Tuyệt — đây là yêu cầu của bạn:' },
  'chat.lblSvc':    { en: 'Services', vi: 'Dịch vụ' },
  'chat.lblName':   { en: 'Name', vi: 'Họ tên' },
  'chat.lblPhone':  { en: 'Phone', vi: 'Điện thoại' },
  'chat.lblTimes':  { en: 'Best times', vi: 'Thời gian' },
  'chat.send':      { en: "Tap below — we'll open WhatsApp to confirm your booking. 💛", vi: 'Chạm bên dưới — chúng tôi sẽ mở WhatsApp để xác nhận lịch của bạn. 💛' },
  'chat.sendwa':    { en: 'Send to WhatsApp →', vi: 'Gửi qua WhatsApp →' },
  'chat.restart':   { en: 'Start over', vi: 'Bắt đầu lại' },
